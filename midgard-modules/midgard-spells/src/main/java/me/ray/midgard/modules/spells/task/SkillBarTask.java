...
public class SkillBarTask extends BukkitRunnable {
    ...
    private void updateActionBar(Player player) {
        ...
        CombatData combatData = (coreProfile != null) ? coreProfile.getData(CombatData.class) : null;
        double currentMana = (combatData != null) ? combatData.getCurrentMana() : 10000;
