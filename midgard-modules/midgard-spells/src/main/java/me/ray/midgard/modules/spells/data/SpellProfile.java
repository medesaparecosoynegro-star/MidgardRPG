...
public class SpellProfile implements ModuleData {
    ...
    // Estado das Matrizes: Spell ID -> MatrixState
    private final Map<String, MatrixState> matrixStates = new HashMap<>();
    ...
    public MatrixState getMatrixState(String spellId) {
        return matrixStates.computeIfAbsent(spellId, k -> new MatrixState());
    }
